...
If you operate a self-hosted PotatoBot instance and suffer a security incident:
...
- If you need upstream help, file a private security advisory and include sanitized reproduction steps and the PotatoBot version/commit.
...
## Privacy & Telemetry
- PotatoBot does not phone home or collect usage data by default. (If you plan to add telemetry, it must be opt-in, documented, and transparent.)
...
Thank you for helping keep PotatoBot safe.
